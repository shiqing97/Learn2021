...
function latestVersion(packageName, isBeta) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"].get(getPackageRegistry() + "/" + packageName, {
                        timeout: 1000 * 10
                    })];
                case 1:
                    response = _a.sent();
